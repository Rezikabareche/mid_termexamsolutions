...
public class LowestNumber {
    ...
    public static void main(String[] args) {
        ...
        int lowestValue = array[0];  // initialize with the first element of the array
        for (int i = 1; i < array.length; i++) {  // start from the second element
            if (array[i] < lowestValue) {
                lowestValue = array[i];  // update lowestValue if we find a smaller number
                System.out.println("The lowest value in this array is: " + lowestValue);
