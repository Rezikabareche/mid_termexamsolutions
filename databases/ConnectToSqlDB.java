...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("C:\\Users\\My Pc\\IdeaProjects\\midterm-coding-exam\\src\\secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
    ...
    public void insertDataFromArrayToSqlTable(int [] ArrayData, String tableName, String columnName)
    {
        try {
            connectToSqlDatabase();
            ps = connect.prepareStatement("DROP TABLE  students IF EXISTS ;");
            ps.executeUpdate();
    ...
    public void insertProfileToSqlTable(String tableName, String columnName1, String columnName2)
    {
        try {
            connectToSqlDatabase();
                ps = connect.prepareStatement("INSERT INTO students    + "," + columnName2 + " ) VALUES(name,DOB)");
